    ...
    def evaluate(self, expression, i1=None, i2=None, out=None, selection=None, filtered=True, internal=False, parallel=True):
        ...
        if parallel:
            ...
            def assign(thread_index, i1, i2, *blocks):
                if selection:
                    selection_mask = self.evaluate_selection_mask(selection, i1=i1, i2=i2, cache=True)
            ...
            self.map_reduce(assign, lambda *_: None, expressions, ignore_filter=False, pre_filter=use_filter, info=True, to_numpy=False)
